...
class ErrorHandlingMiddleware(BaseHTTPMiddleware):
    ...
    async def _handle_http_exception(
        self, exc: HTTPException, request_context: Dict[str, Any], timestamp: str
    ) -> JSONResponse:
    ...
    async def _handle_pydantic_validation_error(
        self, exc: ValidationError, request_context: Dict[str, Any], timestamp: str
    ) -> JSONResponse:
    ...
    async def _handle_unexpected_exception(
        self, exc: Exception, request_context: Dict[str, Any], timestamp: str
    ) -> JSONResponse:
...
def create_exception_handlers() -> Dict[Union[int, type], Any]:
    ...
    async def media_planner_exception_handler(
        request: Request, exc: MediaPlannerException
    ):
