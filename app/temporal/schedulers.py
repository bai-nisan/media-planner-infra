...
class SyncScheduler:
        ...
        schedule = Schedule(
            ...
            policy=Schedule.Policy(
                ...
                catchup_window=timedelta(
                    minutes=schedule_config.get("catchup_window_minutes", 60)
                ),
    ...
    async def create_multi_tenant_sync_schedule(
        self, tenants: List[Dict[str, Any]], schedule_config: Dict[str, Any]
    ) -> ScheduleHandle:
        """
    ...
    async def update_tenant_sync_schedule(
        self, tenant_id: str, new_config: Dict[str, Any]
    ) -> bool:
        """
    ...
    async def trigger_immediate_sync(
        self, tenant_id: str, overlap_policy: str = "skip"
    ) -> bool:
        """
...
async def setup_default_sync_schedules(
    client: Client, tenants: List[Dict[str, Any]]
) -> SyncScheduler:
    """
    ...
    monitor_config = {
        ...
        "notification_settings": {"health_alerts": ["admin@company.com"]},
        "timezone": "UTC",
    }
