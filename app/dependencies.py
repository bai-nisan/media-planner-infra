...
def get_tenant_id(request: Request, settings: Settings = get_settings()) -> str:
    """
...
async def verify_temporal_health(temporal_service: TemporalService = get_temporal_service) -> bool:
    """
