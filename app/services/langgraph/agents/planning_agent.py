...
class PlanningAgent(BaseAgent):
    ...
    async def _handle_budget_optimization(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not campaigns:
            campaigns = [
                {"id": "search_campaign", "name": "Search Campaign", "platform": "Google Ads"},
                {"id": "social_campaign", "name": "Social Media Campaign", "platform": "Meta Ads"},
                {"id": "linkedin_campaign", "name": "LinkedIn Professional", "platform": "LinkedIn Ads"}
            ]
        ...
        strategic_recommendations = await self._generate_budget_strategy(optimization_result)
        ...
        return {
            ...
            "recommendations_summary": {
                "primary_recommendation": strategic_recommendations[0] if strategic_recommendations else None,
                "estimated_improvement": optimization_result.get("estimated_improvement", "15-25%"),
                "implementation_complexity": "low"
            }
        }
    
    async def _handle_campaign_planning(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        """Handle comprehensive campaign planning."""
        logger.info("Executing campaign planning")
        
        # Extract parameters
        campaign_objectives = task_data.get("objectives", {
        ...
        budget_allocation = task_data.get("budget_allocation", {
            "total_budget": 40000,
            "allocated_campaigns": []
        })
        ...
        implementation_roadmap = await self._create_implementation_roadmap(planning_result)
    ...
    async def _handle_timeline_planning(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_resource_allocation(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_general_planning(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _generate_budget_strategy(self, optimization_result: Dict[str, Any]) -> List[str]:
        ...
        for campaign in optimized_allocation:
            ...
            if platform not in platform_performance:
                platform_performance[platform] = {"budget": 0, "percentage": 0, "campaigns": 0}
    ...
    async def _create_implementation_roadmap(self, planning_result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _define_next_steps(self, planning_result: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        next_steps.extend([
            {
                ...
                "success_metrics": ["Dashboard operational", "Real-time data flowing"]
            },
            {
                ...
                "success_metrics": ["Review meeting scheduled", "Success criteria defined"]
            }
        ])
    ...
    async def _generate_project_timeline(
        ...
        timeline = {
            "project_overview": {
                ...
                "end_date": (datetime.utcnow() + timedelta(weeks=duration_weeks)).date().isoformat(),
        ...
        phases = [
            {"name": "Initiation & Setup", "activities": ["Project kickoff", "Resource allocation", "Initial setup"]},
            {"name": "Execution & Development", "activities": ["Core implementation", "Testing", "Optimization"]},
            {"name": "Delivery & Closure", "activities": ["Final delivery", "Performance review", "Project closure"]}
        ]
        ...
        for i, phase in enumerate(phases):
            ...
            timeline["phases"].append({
                ...
                "deliverables": deliverables[i::3] if deliverables else []  # Distribute deliverables
            })
    ...
    async def _optimize_resource_allocation(
        ...
        for resource_type in resource_types:
            ...
            allocation["utilization_metrics"][resource_type] = {
                ...
                "optimization_potential": "high" if utilization < 0.7 else "medium" if utilization < 0.9 else "low"
            }
    ...
    async def _create_comprehensive_plan(
        ...
        plan["success_metrics"] = [
            ...
            {"metric": "Performance improvement", "target": "25% increase", "measurement": "quarterly"},
            {"metric": "Efficiency gains", "target": "30% time savings", "measurement": "ongoing"}
        ]
    ...
    async def _estimate_phase_resources(self, phase: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "skill_requirements": ["project_management", "digital_marketing", "analytics"],
            "tools_required": ["project_management_software", "analytics_platform"],
            "budget_estimate": total_hours * 75  # $75/hour rate
        }
    
    async def _assess_timeline_risks(self, timeline_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        total_weeks = timeline_result.get("project_overview", {}).get("total_duration_weeks", 12)
        if total_weeks < 8:
