    ...
    async def analyze_performance_data(
        ...
        try:
            ...
            analysis_results = {
                ...
                "trend_analysis": {
                    "ctr": {"direction": "increasing", "significance": "significant", "slope": 0.02},
                    "conversions": {"direction": "stable", "significance": "not_significant", "slope": 0.001},
                    "spend": {"direction": "increasing", "significance": "significant", "slope": 15.3}
                },
...
class TrendDetector(BaseTool):
    ...
    def __init__(self):
        ...
        self.description = "Detects trends, patterns, and seasonal effects in campaign data"
...
class InsightGenerator(BaseTool):
    ...
    def __init__(self):
        ...
        self.description = "Generates actionable insights and optimization recommendations"
    ...
    async def evaluate_performance(
        ...
        try:
            ...
            evaluation_results = {
                ...
                "strengths": ["Strong click-through rates", "Excellent ROAS performance"],
