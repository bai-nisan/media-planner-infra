...
class BudgetOptimizer(BaseTool):
    ...
    async def optimize_budget(
        ...
        try:
            logger.info(
                f"Optimizing budget of ${total_budget} across {len(campaigns)} campaigns"
            )
            ...
            return {
                ...
                "optimization_method": (
                    "performance_based" if performance_data else "weighted_allocation"
                ),
    ...
    async def _performance_based_allocation(
        ...
        for campaign in campaigns:
            ...
            allocated_budget = max(
                min_budget,
                min(
                    performance_allocation, max_budget, platform_limit, remaining_budget
                ),
            )
            ...
            allocation.append(
                {
                    ...
                    "allocation_percentage": round(
                        (allocated_budget / total_budget) * 100, 1
                    ),
                }
            )
    ...
    async def _validate_allocation(
        self, allocation: List[Dict[str, Any]], constraints: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        for campaign in allocation:
            ...
            platform_totals[platform] = (
                platform_totals.get(platform, 0) + campaign["allocated_budget"]
            )
    ...
    async def execute(
        ...
        return await self.optimize_budget(
            total_budget, campaigns, performance_data, constraints
        )
...
class CampaignPlanner(BaseTool):
    ...
    def __init__(self):
        ...
        self.description = (
            "Creates comprehensive campaign plans with timelines and milestones"
        )
    ...
    async def create_campaign_plan(
        ...
        try:
            logger.info(
                f"Creating campaign plan for objectives: {campaign_objectives.get('primary_goal')}"
            )
            ...
            checklist = await self._create_execution_checklist(
                phases, budget_allocation
            )
            ...
            return {
                "campaign_plan": {
                    ...
                    "timeline_summary": {
                        "total_duration_weeks": timeline_constraints[
                        ...
                        "estimated_end_date": (
                            datetime.utcnow()
                            + timedelta(
                                weeks=timeline_constraints["campaign_duration_weeks"]
                            )
                        )
                        .date()
                        .isoformat(),
    ...
    async def _generate_campaign_phases(
        self, timeline_constraints: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        ...
        phases = [
            ...
            },
            {
                ...
                - timeline_constraints["setup_phase_days"]
                - timeline_constraints["optimization_phase_days"],
                "activities": [
    ...
    async def _create_milestones(
        self, phases: List[Dict[str, Any]], objectives: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        ...
        for i, phase in enumerate(phases):
            if phase["phase"] == "Setup & Launch":
                ...
                for week in range(0, phase_duration, 7):
                    milestone_date = (
                        (phase_start + timedelta(days=week)).date().isoformat()
                    )
                    milestones.append(
                        {
    ...
    async def _define_kpis(self, objectives: Dict[str, Any]) -> Dict[str, Any]:
        ...
        base_kpis = {
            "reach_metrics": {
                "impressions": {
                    "target": objectives.get("target_impressions"),
                    "unit": "count",
                },
                "reach": {
                    "target": objectives.get("target_reach"),
                    "unit": "unique_users",
                },
            ...
            "efficiency_metrics": {
                "cpm": {
                    "target": objectives.get("target_cpm", "$15"),
                    "unit": "cost_per_mille",
                },
                "cpc": {
                    "target": objectives.get("target_cpc", "$2.50"),
                    "unit": "cost_per_click",
                },
            },
        }
        ...
        if primary_goal == "lead_generation":
            goal_specific_kpis["conversion_metrics"] = {
                "leads_generated": {
                    "target": objectives.get("target_leads"),
                    "unit": "count",
                },
                "cost_per_lead": {
                    "target": objectives.get("max_cpl"),
                    "unit": "currency",
                },
            ...
            goal_specific_kpis["revenue_metrics"] = {
                "revenue_generated": {
                    "target": objectives.get("target_revenue"),
                    "unit": "currency",
                },
                "roas": {
                    "target": objectives.get("target_roas", "4:1"),
                    "unit": "ratio",
                },
                "cost_per_acquisition": {
                    "target": objectives.get("max_cpa"),
                    "unit": "currency",
                },
            ...
            goal_specific_kpis["awareness_metrics"] = {
                "brand_lift": {
                    "target": objectives.get("target_brand_lift", "10%"),
                    "unit": "percentage",
                },
    ...
    async def _create_execution_checklist(
        self, phases: List[Dict[str, Any]], budget_allocation: Dict[str, Any]
        ...
        for phase in phases:
            ...
            if phase_name == "Setup & Launch":
                checklist[phase_name] = [
                    {
                        "task": "Set up Google Ads campaigns",
                        "priority": "high",
                        "estimated_hours": 4,
                    },
                    {
                        "task": "Configure Meta Ads campaigns",
                        "priority": "high",
                        "estimated_hours": 3,
                    },
                    {
                    ...
                    {
                        "task": "Configure analytics dashboards",
                        "priority": "medium",
                        "estimated_hours": 3,
                    },
                    {
                    ...
                    {
                        "task": "Verify tracking and attribution",
                        "priority": "critical",
                        "estimated_hours": 2,
                    },
                ]
                ...
                checklist[phase_name] = [
                    {
                        "task": "Daily performance monitoring",
                        "priority": "high",
                        "estimated_hours": 1,
                    },
                    {
                    ...
                    {
                        "task": "A/B test creative variations",
                        "priority": "medium",
                        "estimated_hours": 4,
                    },
                    {
                        "task": "Optimize audience targeting",
                        "priority": "high",
                        "estimated_hours": 2,
                    },
                    {
                        "task": "Adjust budget allocation",
                        "priority": "high",
                        "estimated_hours": 1,
                    },
                    {
                        "task": "Optimize bidding strategies",
                        "priority": "medium",
                        "estimated_hours": 2,
                    },
                ]
                ...
                checklist[phase_name] = [
                    {
                        "task": "Scale high-performing campaigns",
                        "priority": "high",
                        "estimated_hours": 2,
                    },
                    {
                        "task": "Regular performance reviews",
                        "priority": "high",
                        "estimated_hours": 2,
                    },
                    {
                        "task": "Prepare weekly reports",
                        "priority": "medium",
                        "estimated_hours": 3,
                    },
                    {
                    ...
                    {
                        "task": "Monitor competitive landscape",
                        "priority": "low",
                        "estimated_hours": 1,
                    },
                    {
                        "task": "Prepare final campaign analysis",
                        "priority": "high",
                        "estimated_hours": 4,
                    },
                ]
    ...
    async def execute(
        ...
        return await self.create_campaign_plan(
            campaign_objectives, budget_allocation, timeline_constraints
        )
