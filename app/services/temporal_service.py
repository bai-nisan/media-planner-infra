...
class MediaPlanningWorkflowService:
    ...
    async def start_budget_optimization(
        self, campaign_id: str, tenant_id: str, optimization_goals: Dict[str, Any]
    ) -> str:
        """
        ...
        try:
            ...
            handle = await self.temporal_client.start_workflow(
                ...
                workflow_id=workflow_id,
                task_queue=self.settings.TEMPORAL_TASK_QUEUE_PLANNING,
                memo={"campaign_id": campaign_id, "tenant_id": tenant_id},
                search_attributes={
                    "CampaignId": campaign_id,
                    "TenantId": tenant_id,
...
class IntegrationWorkflowService:
    ...
    async def start_platform_sync(
        self, platform: str, tenant_id: str, sync_params: Dict[str, Any]
    ) -> str:
        """
        ...
        try:
            ...
            handle = await self.temporal_client.start_workflow(
                ...
                memo={"platform": platform, "tenant_id": tenant_id},
                search_attributes={
                    "Platform": platform,
                    "TenantId": tenant_id,
    ...
    async def start_data_import(
        self, source: str, tenant_id: str, import_config: Dict[str, Any]
    ) -> str:
        """
        ...
        try:
            ...
            handle = await self.temporal_client.start_workflow(
                ...
                workflow_id=workflow_id,
                task_queue=self.settings.TEMPORAL_TASK_QUEUE_INTEGRATION,
                memo={"source": source, "tenant_id": tenant_id},
                search_attributes={
                    "Source": source,
                    "TenantId": tenant_id,
...
class SyncWorkflowService:
    ...
    async def start_scheduled_sync(
        self, sync_type: str, tenant_id: str, schedule_config: Dict[str, Any]
    ) -> str:
        """
        ...
        try:
            ...
            handle = await self.temporal_client.start_workflow(
                ...
                memo={"sync_type": sync_type, "tenant_id": tenant_id},
                search_attributes={
                    "SyncType": sync_type,
                    "TenantId": tenant_id,
...
class WorkflowManagementService:
    ...
    async def list_workflows_by_tenant(
        self, tenant_id: str, limit: int = 100, status_filter: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            health_status = {
                "status": (
                    "healthy"
                    if client_healthy and list_workflows_healthy
                    else "unhealthy"
                ),
