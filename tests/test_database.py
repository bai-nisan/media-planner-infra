...
class TestDatabaseBridge:
    ...
    def test_client_initialization(self, mock_create_client):
        ...
        mock_create_client.assert_called_once_with(
            self.db_bridge.settings.SUPABASE_URL,
            self.db_bridge.settings.SUPABASE_KEY
        )
...
class TestDatabaseEndpoints:
    ...
    def test_workflow_history_endpoint(self, mock_get_bridge):
        ...
        response = self.client.get("/api/v1/database/workflow-history/campaign_analysis?limit=5")
