...
class WorkspaceTestNode:
    ...
    def __init__(self):
        ...
        self.workspace_agent = WorkspaceAgent(
            auth_manager=self.auth_manager, settings=self.settings
        )
    ...
    async def _execute_workspace_test(
        self, state: CampaignPlanningState, scenario: str
    ) -> Dict[str, Any]:
    ...
    async def _test_google_sheets_extraction(
        ...
        try:
            ...
            return {
                ...
                "google_sheets_data": {
                    ...
                    "next_agent": (
                        command_result.goto if hasattr(command_result, "goto") else None
                    ),
                },
    ...
    async def _test_data_validation(
        self, state: CampaignPlanningState
    ) -> Dict[str, Any]:
    ...
    async def _test_file_discovery(
        self, state: CampaignPlanningState
    ) -> Dict[str, Any]:
    ...
    async def _test_workspace_analysis(
        self, state: CampaignPlanningState
    ) -> Dict[str, Any]:
    ...
    async def _test_data_transformation(
        self, state: CampaignPlanningState
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            initial_state = {
                "messages": [
                    {
                        "role": "human",
                        "content": "Test Google Sheets extraction functionality",
                    }
                ],
