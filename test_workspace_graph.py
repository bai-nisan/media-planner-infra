...
async def test_workspace_scenarios():
    ...
    test_scenarios = [
        ...
        },
        {
            ...
            "message": "Test data validation capabilities"
        },
        {
            "name": "File Discovery",
            "message": "Test file discovery functionality"
        },
        {
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        try:
            ...
            initial_state = {
                "messages": [
                    {"role": "human", "content": scenario['message']}
                ],
            ...
            if hasattr(final_message, 'metadata'):
                success = final_message.metadata.get('success', False) if final_message.metadata else False
                content = final_message.content if hasattr(final_message, 'content') else 'No content'
            else:
