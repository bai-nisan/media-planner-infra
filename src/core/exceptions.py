...
class ModelProcessingError(AIWorkflowError):
    ...
    def __init__(
        ...
        super().__init__(message, workflow_id, "MODEL_PROCESSING_ERROR", details)
...
class CampaignProcessingError(AIWorkflowError):
    ...
    def __init__(
        ...
        super().__init__(message, workflow_id, "CAMPAIGN_PROCESSING_ERROR", details)
...
def create_http_exception(
    ...
    """
    error_response = {"error_code": exc.error_code, "message": exc.message}
